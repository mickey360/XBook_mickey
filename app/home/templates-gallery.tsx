...
import { toast } from "sonner";
 ...
 export const TemplatesGallery = () => {
    ...
    return ( 
        <div className="bg-gradient-to-r from-black to-gray-950">
            <div className="max-w-screen-xl mx-auto px-16 py-6 flex flex-col gap-y-4">
                <h3 className="font-medium text-gray-200">Start a new document</h3>
                <Carousel >
                        ...
                        {templates.map((template) => (
                            <CarouselItem key={template.id} className="basis-1/2 sm:basis-1/3 md:basis-1/4 lg:basis-1/5 xl:basis-1/6 2xl:basis[14.285714%] pl-4">
                                ...
                                <div className={cn("aspect-[3/4] flex flex-col gap-y-2.5", isCreating && "pointer-events-none opacity-50")}>
                                    ...
                                    className="size-full hover:border-gray-700 rounded-sm border hover:bg-gray-900 transition flex flex-col items-center justify-center gap-y-4 bg-black "
                                    />
