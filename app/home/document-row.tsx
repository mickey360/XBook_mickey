...
export const DocumentRow = ({ document }: DocumentRowProps) => {
    ...
    return (
        <TableRow onClick={() => router.push(`/documents/${document._id}`)}  className="cursor-pointer border-b-gray-800 hover:bg-gray-950">
            <TableCell className="w-[50px]">
                <SiGoogledocs className="size-6 fill-blue-500"/>
            </TableCell>
            <TableCell className="font-medium text-gray-400 md:w-[45%]">
                {document.title}
            </TableCell>
